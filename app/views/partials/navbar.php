    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarButtonsExample">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<li class="nav-item">
                    <a class="nav-link" href="#">Mua ACC</a>
                </li>
				<li class="nav-item">
                    <a class="nav-link" href="#">Dịch Vụ</a>
                </li>
				<li class="nav-item">
                    <a class="nav-link" href="#">Mua Thẻ</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/sponsors">Donate</a>
                </li>
            ...
            <div class="d-flex align-items-center">
                <a class="btn btn-dark px-3 me-3" href="#" target="_blank"><i class="fab fa-github"></i></a>
